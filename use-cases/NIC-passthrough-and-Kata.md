...
Note: that the ‘’’ xxxx xxxx ’’’ format is of the correct form and not a mistake.
...
* To create the container without been transferd into it add ‘d’ (for detached) to the command line flags (‘’’ # docker run -itd ‘’’)
